...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CadastrodeCurso/css/style.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Questrial">
    </head>
    <body>
        <div id="container">
            <form action="CriarCurso" method="post" id="formCurso">
                ...
                <input type="text" class="campo" id="nome" name="nome" placeholder="Nome do curso">
