...
<body>
    ...
    <div class="notificationCard">
      ...
      <p class="notificationPara">Ao clicar em sair você sera redirecionado para a página inicial</p>
        <div class="buttonContainer">
            <button id="sair" class="AllowBtn" onclick="cliqueSair()"><a href="deslogar.jsp"> Sair</a></button> 
          <button id="voltar" class="NotnowBtn" onclick="voltar()"><a href="VoltarAdm">Voltar</a></button>
        </div>
      </div>
</body>
